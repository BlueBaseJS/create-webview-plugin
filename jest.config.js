...
module.exports = ({ config }) => {
	config = storybookWebpackConfigs({
		config,
	});
	...
	config.module.rules.push({
		test: /\.js$/,
		exclude: /node_modules\/(?!(react-native-webview|react-native-elements|react-native-vector-icons|expo-image-picker|react-native-animatable|react-native-svg|rn-placeholder|react-native-reanimated|expo-face-detector|react-native-gesture-handler|expo-linear-gradient|expo-payments-stripe|expo-gl|expo-av|expo-camera|expo|expo-barcode-scanner|expo-ads-admob|expo-blur|@expo\/vector-icons|@unimodules\/react-native-adapter)\/).*/,
		loader: 'babel-loader',
	});
